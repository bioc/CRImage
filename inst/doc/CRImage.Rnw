...
\bigskip
$\ast$ E-mail: henrik.failmezger@cip.ifi.lmu.de
\end{center}
\end{flushleft}
\tableofcontents
...
\begin{figure}
\centerline{\includegraphics[width=0.5\textwidth]{exImg2}
\includegraphics[width=0.4\textwidth]{exImg3}
\includegraphics[width=0.4\textwidth]{imgCorrected}
{segmentedImage}}
